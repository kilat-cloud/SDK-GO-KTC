...
// mockStrategyTarget_Logger_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Logger'
type mockStrategyTarget_Logger_Call struct {
	*mock.Call
}

// Logger is a helper method to define mock.On call
func (_e *mockStrategyTarget_Expecter) Logger() *mockStrategyTarget_Logger_Call {
	return &mockStrategyTarget_Logger_Call{Call: _e.mock.On("Logger")}
}

func (_c *mockStrategyTarget_Logger_Call) Run(run func()) *mockStrategyTarget_Logger_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *mockStrategyTarget_Logger_Call) Return(_a0 *slog.Logger) *mockStrategyTarget_Logger_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *mockStrategyTarget_Logger_Call) RunAndReturn(run func() *slog.Logger) *mockStrategyTarget_Logger_Call {
	_c.Call.Return(run)
	return _c
}
