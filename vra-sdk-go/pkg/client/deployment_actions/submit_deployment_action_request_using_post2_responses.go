...
func (o *SubmitDeploymentActionRequestUsingPOST2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewSubmitDeploymentActionRequestUsingPOST2BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSubmitDeploymentActionRequestUsingPOST2BadRequest creates a SubmitDeploymentActionRequestUsingPOST2BadRequest with default headers values
func NewSubmitDeploymentActionRequestUsingPOST2BadRequest() *SubmitDeploymentActionRequestUsingPOST2BadRequest {
	return &SubmitDeploymentActionRequestUsingPOST2BadRequest{}
}

/*
SubmitDeploymentActionRequestUsingPOST2BadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type SubmitDeploymentActionRequestUsingPOST2BadRequest struct {
	Payload *models.Error
}

// IsSuccess returns true when this submit deployment action request using p o s t2 bad request response has a 2xx status code
func (o *SubmitDeploymentActionRequestUsingPOST2BadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this submit deployment action request using p o s t2 bad request response has a 3xx status code
func (o *SubmitDeploymentActionRequestUsingPOST2BadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this submit deployment action request using p o s t2 bad request response has a 4xx status code
func (o *SubmitDeploymentActionRequestUsingPOST2BadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this submit deployment action request using p o s t2 bad request response has a 5xx status code
func (o *SubmitDeploymentActionRequestUsingPOST2BadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this submit deployment action request using p o s t2 bad request response a status code equal to that given
func (o *SubmitDeploymentActionRequestUsingPOST2BadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *SubmitDeploymentActionRequestUsingPOST2BadRequest) Error() string {
	return fmt.Sprintf("[POST /deployment/api/deployments/{deploymentId}/requests][%d] submitDeploymentActionRequestUsingPOST2BadRequest  %+v", 400, o.Payload)
}

func (o *SubmitDeploymentActionRequestUsingPOST2BadRequest) String() string {
	return fmt.Sprintf("[POST /deployment/api/deployments/{deploymentId}/requests][%d] submitDeploymentActionRequestUsingPOST2BadRequest  %+v", 400, o.Payload)
}

func (o *SubmitDeploymentActionRequestUsingPOST2BadRequest) GetPayload() *models.Error {
	return o.Payload
}

func (o *SubmitDeploymentActionRequestUsingPOST2BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
